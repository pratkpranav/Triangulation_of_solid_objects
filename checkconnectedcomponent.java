...
public class checkconnectedcomponent {
...
//				System.out.println(E3.y.z);
	...
	public static void dfs(RBTree<Triangle,Triangle> rbcomponent,
	...
	public static void main(String [] args)
	{
		for(int i=0; i<9 ; i ++)
		{
			...
			for(int j = 0; j< 3 ; j++)
			{
				triangle_coord[j] = (float) Math.random();
			}
			triangle_coord[3] = 0;
			triangle_coord[4] = 1;
			triangle_coord[5] = -1;
